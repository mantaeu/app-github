...
// Create a simple web app that connects to your backend
const indexHtml = `
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <script>
        const API_BASE_URL = 'https://manteau-app1-oa9l9l2ec-mantaeus-projects.vercel.app/api';
...
console.log('✅ Simple frontend created successfully!');
console.log('📁 Files created in web-build/ directory');
console.log('🚀 This connects to your backend API!');
console.log('🔗 Backend: https://manteau-app1-oa9l9l2ec-mantaeus-projects.vercel.app/api');